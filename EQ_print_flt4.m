function EQ_print_flt4 (finput,data,EQin)

%                              EQ_print_flt4.m
%      EQ Function that Format Prints the Input for Fault Model Type 4
%                     Nathanael Wong Zhixin, Feng Lujia
%
% This function format prints the input for the fault variables according
% to the fault model of format type 4.
%
% Format type 4 requires the longitude and latitude coordinates of only the
...
%
% FORMAT OF CALL: EQ_print_flt4 (finput, ...
%                     flttype, fltName, ...
