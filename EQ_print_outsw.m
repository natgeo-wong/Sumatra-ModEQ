function [ outName ] = EQ_print_outsw (xx,outmat,data,GPS)
...
% GPS displacement information for the small (weighted variance explained)
% loop
%
% INPUT:
% -- xx     : rake ii
...
% -- fID : filename
%
% FORMAT OF CALL: EQ_print_outsw (rakeii,mfitmat,data)
