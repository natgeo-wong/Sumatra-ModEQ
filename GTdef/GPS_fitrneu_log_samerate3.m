function [ gparam,err,wrms,rchi2 ] = GPS_fitrneu_log_samerate3(rneu,dflag,Teq,dday)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                        GPS_fitrneu_log_samerate3.m				%
...
%										%
% uses GPS_lsqnonlin_logfunc_samerate3.m					%
% [ diff ] = GPS_lsqnonlin_logfunc_samerate3(xx,rneu,Teq)			%
%   xx = [ n_b n_v n_O n_a      						%
%          e_b e_v e_O e_a      						%
%          u_b u_v u_O u_a tau ]						%
% first created by lfeng Tue Mar 20 15:48:57 SGT 2012				%
% last modified by lfeng Wed Mar 21 10:49:10 SGT 2012                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
lsqnonlin(@(xx) GPS_lsqnonlin_logfunc_samerate3(xx,rneuCurr,Teq),x0,lb,ub,options);	
% check if successful
%if exitflag~=1, error('GPS_fitrneu_log_samerate3 ERROR: do not converge!'); end
% how good is the fit!
chi2  = resnorm;
...
wrms  = sqrt(wrms2);
gparam = [ xx(1:4) xx(13) xx(5:8) xx(13) xx(9:12) xx(13) ];
