function [ diff ] = GPS_lsqnonlin_logfunc_samerateN(xx,rneuCell,Teq)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                    GPS_lsqnonlin_logfunc_samerateN			%
...
%                                                                       %
% called by GPS_fitrneu_log_samerateN.m					%
% first created by lfeng Wed Mar 28 11:05:16 SGT 2012			%
% last modified by lfeng Wed Mar 28 11:12:21 SGT 2012			%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
