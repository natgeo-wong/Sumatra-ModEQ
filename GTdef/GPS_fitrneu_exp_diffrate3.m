function [ eparam,err,wrms,rchi2 ] = GPS_fitrneu_exp_diffrate3(rneu,dflag,Teq,dday)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                          GPS_fitrneu_exp_diffrate3.m				%
...
%										%
% uses GPS_lsqnonlin_expfunc_diffrate3.m					%
% [ diff ] = GPS_lsqnonlin_expfunc_diffrate3(xx,rneu,Teq)			%
...
% last modified by lfeng Tue Mar 20 16:23:03 SGT 2012				%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
lsqnonlin(@(xx) GPS_lsqnonlin_expfunc_diffrate3(xx,rneuCurr,Teq),x0,lb,ub,options);	
% check if successful
%if exitflag~=1, error('GPS_fitrneu_exp_diffrate3 ERROR: do not converge!'); end
% how good is the fit!
...
wrms  = sqrt(wrms2);
eparam = [ xx(1:5) xx(16) xx(6:10) xx(16) xx(11:15) xx(16) ];
