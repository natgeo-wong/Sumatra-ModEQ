function [ xloCell,xupCell,levelCell ] = GAMRA_extents2cell(xlo,xup,level,dx)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                            GAMRA_extents2cell                                 %
% loop thourgh all the patches                                                  %
% divide patch extents in 3D into smaller cells using dx                        % 
%                                                                               %
% INPUT:                                                                        %
% xlo   - lower bounds                                                          %
