function [ diff ] = GPS_lsqnonlin_logfunc_diffrateN(xx,rneuCell,Teq)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                     GPS_lsqnonlin_logfunc_diffrateN			%
% Simultaneously fit three components in a network with 		%
...
%                                                                       %
% called by GPS_fitrneu_log_diffrateN.m					%
% first created by lfeng Wed Mar 28 06:58:07 SGT 2012			%
% last modified by lfeng Wed Mar 28 07:23:00 SGT 2012			%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
