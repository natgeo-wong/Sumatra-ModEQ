function [ rneuPostSC ] = GPS_lsqnonlin_1site_postSinCos(rneu,eqMat,funcMat,fqMat,xx,tt0)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                       GPS_lsqnonlin_1site_postSinCos                        %
% only keep postSinCosmic deformation & seasonal signals                      %
% remove background rates & all offsets from the time series                  %
...
%                                                                             %
% OUTPUT:                                                                     %
% rneuPostSC - data with rates & all offsets removed                          %
%              errors are kept the same                                       %
%                                                                             %
% first created by Lujia Feng Sat Oct 27 23:04:24 SGT 2012                    %
% modified funcMat lfeng Thu Apr  4 16:32:55 SGT 2013                         %
...
% last modified by Lujia Feng Sun Jul 13 12:01:12 SGT 2014                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
