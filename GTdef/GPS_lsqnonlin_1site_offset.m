function [ rneuOoff ] = GPS_lsqnonlin_1site_offset(rneu,eqMat,funcMat,fqMat,xx,tt0)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                        GPS_lsqnonlin_1site_offset                           %
% only keep coseismic offsets                                                 %
...
%                                                                             %
% OUTPUT:                                                                     %
% rneuOoff - data with only offsets kept                                      %
...
% last modified by Lujia Feng Sun Jul 13 11:33:59 SGT 2014                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
rneuOoff  = rneu;
rneuOoff(:,3:5)  = [ nn-nnModel  ee-eeModel  uu-uuModel  ];
