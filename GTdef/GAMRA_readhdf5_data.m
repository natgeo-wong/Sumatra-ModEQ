function [ lambda,mu,disp,strain ] = GAMRA_readhdf5_data(fileName,level,patch)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                             GAMRA_readhdf5_data                               %
% read lambda,mu,disp,strain out from GAMRA output data files                   %
%                                                                               %
% INPUT:                                                                        %
...
if ~exist(fileName,'file'), error('GAMRA_readhdf5_data ERROR: %s does not exist!',fileName); end
...
basename = ['/processor.00000/level.' num2str(level,'%05d') '/patch.' num2str(patch,'%05d') '/'];
...
% convert to [3*cellNum] to be consistent with GAMRA_readhdf5_summary.m
...
% convert to [9*cellNum] to be consistent with GAMRA_readhdf5_summary.m
