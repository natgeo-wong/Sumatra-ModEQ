function [ gparam,err,wrms,rchi2 ] = GPS_fitrneu_log_diffrateN(rneuCell,dflagCell,Teq,dday)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                         GPS_fitrneu_log_diffrateN.m				%
...
%										%
% uses GPS_lsqnonlin_logfunc_diffrateN.m					%
% [ diff ] = GPS_lsqnonlin_logfunc_diffrateN(xx,rneu,Teq)			%
%  xx  = [ tau n_b n_v1 n_v2 n_O n_a        					%
%              e_b e_v1 e_v2 e_O e_a        					%
%              u_b u_v1 u_v2 u_O u_a ]						%
% first created by lfeng Wed Mar 28 07:24:29 SGT 2012				%
% last modified by lfeng Wed Mar 28 11:36:32 SGT 2012				%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
lsqnonlin(@(xx) GPS_lsqnonlin_logfunc_diffrateN(xx,rneuCurrCell,Teq),x0,lb,ub,options);	
% check if successful
%if exitflag~=1, error('GPS_fitrneu_log_diffrateN ERROR: do not converge!'); end
% how good is the fit!
chi2   = resnorm;
...
gparam(:,1:5)       = oparam(:,1:5);
gparam(:,7:11)      = oparam(:,6:10);
gparam(:,13:17)     = oparam(:,11:15);
gparam(:,[6 12 18]) = tau;
