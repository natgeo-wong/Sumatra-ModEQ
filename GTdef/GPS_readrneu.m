...
% only reads lines started with numbers like 20101021 and ignores others        %
...
%                                                                               %
% first created based on GPS_readrneu.m by lfeng Tue Aug 30 22:38:15 SGT 2011	%
% added zero errors case lfeng Mon Jul  2 17:43:36 SGT 2012                     %
% added scaleIn & scaleOut lfeng Tue Oct 23 17:20:58 SGT 2012                   %
% last modified by lfeng Thu Oct 25 15:08:55 SGT 2012                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% fst column of data always has format like 20101021
stdfst = '^[0-9]{8}';
rneu = [];
