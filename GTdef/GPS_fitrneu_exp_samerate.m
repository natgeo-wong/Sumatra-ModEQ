function [ eparam,err,wrms,rchi2 ] = GPS_fitrneu_exp_samerate(rneu,dflag,Teq,dday)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                           GPS_fitrneu_exp_samerate.m				%
...
%										%
% uses GPS_lsqnonlin_expfunc_samerate.m						%
% [ diff ] = GPS_lsqnonlin_expfunc_samerate(xx,tt,yy,yyErr,Teq)			%
%       xx = [ b v O a tau ]							%
% first created by lfeng Wed Mar  7 13:17:54 SGT 2012				%
% last modified by lfeng Tue Mar 20 14:46:10 SGT 2012				%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ii=1:3
   ...
   lsqnonlin(@(xx) GPS_lsqnonlin_expfunc_samerate(xx,tt,pos,err,Teq),x0,lb,ub,options);	
   % check if successful
   %if exitflag~=1, error('GPS_fitrneu_exp_samerate ERROR: do not converge!'); end
