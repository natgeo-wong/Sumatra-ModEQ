function [ rneuSoff ] = GPS_lsqnonlin_1site_offlim(rneu,eqMat,funcMat,fqMat,xx,tt0,offlim)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                         GPS_lsqnonlin_1site_offlim                          %
% only keep small coseismic offsets                                           %
% remove background rates, seasonal signals & all postseismic deformation     %
% remove large coseismic offsets                                              %
% according to the values of xx                                               %
%                                                                             %
% INPUT:                                                                      %
...
% offlim  - small offset threshold, suggested value is 0.1 m                  %
%                                                                             %
...
%                                                                             %
% OUTPUT:                                                                     %
% rneuSoff - data with only offsets kept                                      %
%            errors are kept the same                                         %
%                                                                             %
% first created by Lujia Feng Thu Mar  6 16:50:10 SGT 2014                    %
...
% last modified by Lujia Feng Sun Jul 13 11:34:39 SGT 2014                    %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for jj=1:eqNum
    ...
    % add offsets
    if abs(nnO) > offlim || abs(eeO) > offlim || abs(uuO) > offlim
...
rneuSoff  = rneu;
rneuSoff(:,3:5)  = [ nn-nnModel  ee-eeModel  uu-uuModel  ];
