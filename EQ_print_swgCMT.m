function [ fID ] = EQ_print_swgCMT (fID,mfitmat,data,k)

%                              EQ_print_swgCMT.m
%         EQ Function that prints eq information for gCMTrake model
...
% -- fID   : filename
%
% FORMAT OF CALL: EQ_print_swgCMT (fID,mfit,data,k)
% 
% OVERVIEW:
...
fprintf (fmfit,'#                     SIZE: gCMT MFIT (%d) (SW)\n\n',k);
