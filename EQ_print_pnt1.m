function EQ_print_pnt1 (finput,sites,vel)

%                              EQ_print_pnt1.m
%      EQ Function that Format Prints Type 1 GPS Data recorded by SuGAr
...
% -- Formatted print (fprintf) of the GPS data of format type 1
%
% FORMAT OF CALL: EQ_print_pnt1 (finput, Stations, Data)
% 
% OVERVIEW:
% 1) This function will take as input imported GPS data of format type 1.
%
...
for i = 1:r
    ...
    disp = vel(i,4)/1000; err = vel(i,5)/1000;
    wgt  = vel(i,6);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%% PRINT VARIABLES %%%%%%%%%%%%%%%%%%%%%%%%%%%

    fprintf(finput,'  point 1      %s',site);
    fprintf(finput,'   ');
    fprintf(finput,'%-10.5f %-10.5f %-7.3f',loc);
    fprintf(finput,'   ');
    fprintf(finput,'%-8.5f',disp);
    fprintf(finput,'   ');
    fprintf(finput,'%-7.5f',err);
    fprintf(finput,'    ');
    fprintf(finput,'%-3.1f\n',wgt);
